    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wing', models.CharField(choices=[('None', 'None'), ('Boys', 'Boys'), ('Girls', 'Girls')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('face_status', models.CharField(default='unknown', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachments', models.FileField(blank=True, null=True, upload_to='diaries/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_class', models.CharField(max_length=10)),
                ('section', models.CharField(max_length=10)),
                ('wing', models.CharField(blank=True, choices=[('None', 'None'), ('Boys', 'Boys'), ('Girls', 'Girls')], default='None', max_length=10, null=True)),
                ('subject', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apsokara.subject')),
