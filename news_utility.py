    ...
    if not df.empty:
        ...
        st.markdown(f'''
            ...
            .aps-ticker-container {{
                ...
                display: flex; align-items: center; margin: 0 !important; height: 40px; overflow: hidden; position: relative;
            }}
            .aps-label {{
                background: #d4af37; color: #1b4332 !important; padding: 0 15px; height: 100%;
                display: flex; align-items: center; font-weight: 900; font-size: 0.8rem; z-index: 10;
